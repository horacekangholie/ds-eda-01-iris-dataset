...
#define CONFIGURE_ARGS " '--prefix=/workspaces/ds-eda-01-iris-dataset/venv' '--with-readline' '--with-libraries=/workspaces/ds-eda-01-iris-dataset/venv/lib' '--with-includes=/workspaces/ds-eda-01-iris-dataset/venv/include' '--with-openssl' '--with-gssapi' '--with-icu' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-zstd' '--with-uuid=e2fs' '--with-system-tzdata=/workspaces/ds-eda-01-iris-dataset/venv/share/zoneinfo' '--with-ldap' 'PG_SYSROOT=undefined' 'build_alias=x86_64-conda-linux-gnu' 'host_alias=x86_64-conda-linux-gnu' 'CC=x86_64-conda-linux-gnu-cc' 'CFLAGS=-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /workspaces/ds-eda-01-iris-dataset/venv/include -fdebug-prefix-map=/croot/postgresql-split_1741123568549/work=/usr/local/src/conda/postgresql-split-17.4 -fdebug-prefix-map=/workspaces/ds-eda-01-iris-dataset/venv=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/workspaces/ds-eda-01-iris-dataset/venv/lib -Wl,-rpath-link,/workspaces/ds-eda-01-iris-dataset/venv/lib -L/workspaces/ds-eda-01-iris-dataset/venv/lib' 'CPPFLAGS=-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /workspaces/ds-eda-01-iris-dataset/venv/include' 'CXX=' 'CPP=/croot/postgresql-split_1741123568549/_build_env/bin/x86_64-conda-linux-gnu-cpp' 'PKG_CONFIG_PATH=/workspaces/ds-eda-01-iris-dataset/venv/lib/pkgconfig'"
